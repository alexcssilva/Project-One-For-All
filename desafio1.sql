...
-- Criando tabela Plans e inserindo dados
...
-- Criando tabela Album e inserindo dados
...
INSERT INTO album (album,artist_id,release_year)
VALUES
    ('Envious', '1', '1990'),
    ('Exuberant', '1', '1993'),
...
-- Criando tabela Song e inserindo dados
...
-- Criando tabela User e inserindo dados
...
(
    ...
    name varchar(300),
    age	varchar(300),
    subscription_date varchar(300),
    plans_id int,
    FOREIGN KEY (plans_id) REFERENCES plans(plans_id)
);

INSERT INTO users (name,age,subscription_date,plans_id)
VALUES
...
-- Criando tabela History e inserindo dados
...
-- Criando tabela Followers e inserindo dados
